        ...
        <footer className="py-4 bg-dark text-white">
            <div className="container">
                <div
                    ...
                    <img src={`${process.env.PUBLIC_URL}/Logo-white.png`} alt="Logo" height="50" />
                ...
                <div className="d-flex pt-3 align-items-baseline justify-content-between flex-sm-row flex-column-reverse">
                    ...
                    <Link to ="#" className="mb-sm-0 mb-3"><img src={`${process.env.PUBLIC_URL}/google-play.png`} alt="Download button" height="50" /></Link>
                </div>
            </div>
        </footer>
    );
